...
class ConfigParser():
    def __init__(self) -> None:
        ...
        if not os.path.exists('config.ini'):
            ...
            self.config.set('config', 'afs_email', 'domain@trustpilot.com')
            self.config.set('config', 'email_subject', 'test email subject')
            self.config.set('config', 'bcc_email', 'anotherEmail@gmail.com')
            self.config.set('config', 'invitation_type', 'service review')
            self.config.set('config', 'smtp_server', 'smtp.gmail.com')
            self.config.set('config', 'smtp_port', '587')
            self.config.set('config', 'smtp_password', 'password')
            self.config.set('config', 'smtp_sender_email', 'senderEmail@gmail.com')
            self.config.set('config', 'recipient_email_checkbox', 'on')
            self.config.set('config', 'recipient_email_entry', 'recipientEmail@gmail.com')
            self.config.set('config', 'reference_id_checkbox', 'on')
            self.config.set('config', 'reference_id_entry', '1234')
            self.config.set('config', 'recipient_name_checkbox', 'on')
            self.config.set('config', 'recipient_name_entry', 'recipientName')
            self.config.set('config', 'locale_combobox_checkbox', 'off')
            self.config.set('config', 'locale_combobox_entry', 'en-US')
            self.config.set('config', 'template_combobox_checkbox', 'off')
            self.config.set('config', 'template_combobox_entry', 'English - Service reviews')
            self.config.set('config', 'sender_email_checkbox', 'off')
            self.config.set('config', 'sender_email_entry', 'senderEmail@domain.com')
            self.config.set('config', 'sender_name_checkbox', 'off')
            self.config.set('config', 'sender_name_entry', 'senderName')
            self.config.set('config', 'reply_to_email_checkbox', 'off')
            self.config.set('config', 'reply_to_email_entry', 'replyToEmail@gmail.com')
            self.config.set('config', 'location_id_checkbox', 'off')
            self.config.set('config', 'location_id_entry', '12345')
            self.config.set('config', 'tags_checkbox', 'testTag,testtag2')
            self.config.set('config', 'tags_entry', '1234,1234')
            self.config.set('config', 'preffered_send_time_checkbox', 'off')
            self.config.set('config', 'preffered_send_time_entry', '0')
            self.config.set('config', 'product_review_invitation_preffered_sendtime_checkbox', 'off')
            self.config.set('config', 'product_review_invitation_preffered_sendtime_entry', '0')
            self.config.set('config', 'product_url_checkbox', 'off')
            self.config.set('config', 'product_url_entry', 'https://www.example.com')
            self.config.set('config', 'product_image_url_checkbox', 'off')
            self.config.set('config', 'product_image_url_entry', 'https://www.example.com/image.jpg')
            self.config.set('config', 'product_name_checkbox', 'off')
            self.config.set('config', 'product_name_entry', 'Example Product')
            self.config.set('config', 'product_sku_checkbox', 'off')
            self.config.set('config', 'product_sku_entry', '1234,12345')
            self.config.set('config', 'product_gtin_checkbox', 'off')
            self.config.set('config', 'product_gtin_entry', '')
            self.config.set('config', 'product_mpn_checkbox', 'off')
            self.config.set('config', 'product_mpn_entry', '')
            self.config.set('config', 'product_brand_checkbox', 'off')
