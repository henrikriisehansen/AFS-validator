...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.reciepent_email_Entry.insert(0, self.data["emails"]["recipientemail"])
        ...
        self.afs_email_Entry.insert(0, self.data['emails']['afsemail'])
        ...
        self.smtp_server_entry.insert(0, self.data['smtp']['smtpserver'])
        ...
        self.smtp_port_entry.insert(0, self.data["smtp"]["smtpport"])
        ...
        self.smtp_password_entry.insert(0, self.data["smtp"]["smtppassword"])
        ...
        self.subject.insert(0, self.data["emails"]["emailsubject"])
        ...
        self.to_email_entry.insert(0, self.data['emails']['recipientemail'])
        ...
        self.combobox.set(self.data["settings"]["invitationtype"])
        ...
        self.send_afs_directly_checkbox._variable.set(self.data["settings"]["sendafsdirectcheckbox"])
        ...
        self.locale_checkbox._variable.set(self.data["settings"]["localecheckbox"])
        ...
        self.template_checkbox._variable.set(self.data["settings"]["templatecheckbox"])
        ...
        self.sku_checkbox._variable.set(self.data["settings"]["skucheckbox"])
        ...
        self.location_id_checkbox._variable.set(self.data["settings"]["locationidcheckbox"])
        ...
        self.location_id_entry.insert(0, self.data["settings"]["locationid"])
        ...
        self.prefferedSendTime_checkbox._variable.set(self.data["settings"]["prefferedsendtimecheckbox"])
        ...
        self.prefferedSendTime_entry.insert(0, self.data["settings"]["prefferedsendtime"])
    ...
    def build_payload(self):
        ...
        self.payload = PayloadBuilder(self.get_payload_type(), **self.data).build()
